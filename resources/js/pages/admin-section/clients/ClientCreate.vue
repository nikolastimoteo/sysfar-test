            ...
            <div class="box-body">
              ...
              <ValidationProvider v-slot="{ errors }" vid="birth_date" name="birth_date" rules="date_format:dd/MM/yyyy">
                <div class="form-group" :class="{ 'has-error': errors[0] }">
                  ...
                  <input type="text" class="form-control" id="birth_date" v-mask="'##/##/####'" v-model="form.birth_date" placeholder="Digite a data de nascimento do cliente" />
                  <span v-if="errors" class="help-block">
                    {{ errors[0] }}
                  </span>
                </div>
              ...
              <ValidationProvider v-slot="{ errors }" vid="phone" name="phone" :rules="{ regex: /\+\d{2}\s\(\d{2}\)\s\d{4,5}\-\d{4}/ }">
                <div class="form-group" :class="{ 'has-error': errors[0] }">
                  ...
                  <input type="text" class="form-control" id="phone" v-mask="'+55 (##) ?#?####-####'" v-model="form.phone" placeholder="Digite o telefone do cliente" />
                  <span v-if="errors" class="help-block">
                    {{ errors[0] }}
                  </span>
                </div>
